...
export function parseDate(date: Date): string {
  ...
  const returnableValueFromDataset = dataset[dateAsFormattedString as keyof typeof dataset];
  return returnableValueFromDataset || ERROR_STRING;
}

const getKeyByValue = (obj: Object, value: any): string => 
        Object.keys(obj).find(key => obj[key as keyof typeof obj] === value) || "error";
